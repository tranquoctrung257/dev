...
while True:
    ...
    os.system(f'adb -s 5210c98de2636439 shell am start -a android.intent.action.VIEW -d {link}')
    # os.system('start '+link)
    for i in range(5,0,-1):
        if (type_acction == "follow"):
            print(syan+'VUI LÒNG THỰC HIỆN FOLLOW TRONG '+trang+str(i)+syan+' GIÂY                                  ',end= "\r")
            time.sleep(3)
            os.system(" adb -s 5210c98de2636439 shell input tap 379 839")
            break
            ...
            os.system(" adb -s 5210c98de2636439 shell input tap 991 951")
            break
        time.sleep(1)
